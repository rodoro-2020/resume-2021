...
\begin{minipage}[t]{0.43\textwidth} % 50% of the page for the skills bar chart
	\vspace{-\baselineskip} % Required for vertically aligning minipages
	\begin{barchart}{5}
		\baritem{Windows OS 70\%}{60}
		\baritem{Linux OS 70\%}{60}
		\baritem{Virtualization 60\%}{50}
		\baritem{Podman & Docker containers 40\%}{30}
		\baritem{Github 40\%}{30}
		\baritem{Scripting/Test Automation 30\%}{20}
	\end{barchart}
\end{minipage}
